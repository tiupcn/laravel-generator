...
class APIRequestGenerator extends BaseGenerator
{
    ...
    {
        $templateData = get_template('angularjs.request.create_request', 'laravel-generator');
    ...
    {
        $templateData = get_template('angularjs.request.update_request', 'laravel-generator');
